...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "78195A55402146CE8D468E2C2EF49F76";
    ...
    public static String aesDecode2(String content, byte[] aesSecert) {
        try {
            //1.构造密钥生成器，指定为AES算法,不区分大小写
            KeyGenerator keygen = getInstance("AES");
            //2.根据ecnodeRules规则初始化密钥生成器
    ...
    public static void main(String[] args) throws Exception {
        String s = aesEncode("你好");
        System.err.println(s);
        String s2 = aesDecode(s);
