...
public class XRsaUtil {
    ...
    public static Map<String, String> createKeys(int keySize) {
        ...
        String aa = (new Random().nextInt(999999999)) + UUID.randomUUID().toString();
    ...
    public String privateDecrypt(String data) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, DECRYPT_MODE, Base64.decodeBase64(data), publicKey.getModulus().bitLength()), CHARSET);
        } catch (Exception e) {
